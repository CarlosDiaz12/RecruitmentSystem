...
namespace RecruitmentSystem.Infrastructure.Migrations
{
    ...
    [Migration("20220217201721_agregarIndiceCedulaEmpleado")]
    partial class agregarIndiceCedulaEmpleado
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecruitmentSystem.Domain.Entities.Candidato", b =>
                {
                    ...
                    b.Property<int>("DepartamentoPerteneceId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DepartamentoPerteneceId");
            ...
            modelBuilder.Entity("RecruitmentSystem.Domain.Entities.Departamento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("RecruitmentSystem.Domain.Entities.Candidato", b =>
                {
                    b.HasOne("RecruitmentSystem.Domain.Entities.Departamento", "DepartamentoPertenece")
                        .WithMany()
                        .HasForeignKey("DepartamentoPerteneceId")
                    ...
                    b.Navigation("DepartamentoPertenece");
            ...
            modelBuilder.Entity("RecruitmentSystem.Domain.Entities.Empleado", b =>
                {
                    b.HasOne("RecruitmentSystem.Domain.Entities.Departamento", "Departamento")
                        .WithMany()
